# Contributing to src2purl

First off, thank you for considering contributing to src2purl! It's people like you that make src2purl such a great tool.
...
```bash
# Clone your fork
git clone https://github.com/your-username/src2purl.git
cd src2purl
...
- [GitHub Discussions](https://github.com/SemClone/src2purl/discussions)
- [Issues](https://github.com/SemClone/src2purl/issues)
